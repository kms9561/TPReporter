...
<ft>인증서 발급/검증</ft><br>
<fs>실제 한 역할을 증명하는 인증서를 발급받거나, 그 인증서의 진위 여부를 확인할 수 있습니다.</fs>
<br><br>

<a href="DoIssueAuth.jsp"><fh>지금 인증서 발급받기</fh></a>&nbsp;&nbsp;&nbsp;    
<a href="AuthCheck.jsp" target=_blank><fh>지금 인증서 검증하기</fh></a>
